...
//Client: Update daily exercise
router.route('/update-exercise').post((req, res) => {
	let { user, date, cardiotime, cardiotype, addtltraining, notes } = req.body;
